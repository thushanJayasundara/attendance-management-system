...
(function (h) {
    ...
    m.ext = x = {
        buttons: {},
        classes: {},
        build: "dt/dt-1.10.16/b-1.5.1/fc-3.2.4/fh-3.1.3/r-2.2.1/sc-1.4.3/sl-1.2.4",
        errMode: "alert",
        feature: [],
        search: [],
...
(function (e) {
    ...
    o("columns().deselect()", "column().deselect()", function () {
        ...
        this.iterator("column", function (c, b) {
            ...
            a.cells(null, b).indexes().each(function (b) {
                var a =
                    c.aoData[b.row], d = a._selected_cells;
    ...
    e.extend(g.ext.buttons, {
        selected: {
            text: q("selected", "Selected"), className: "buttons-selected", init: function (a, c, b) {
                var d = this;
